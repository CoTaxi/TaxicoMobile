...
public class BlogForm extends BaseForm
{
        ...
        private Image i;
    public BlogForm(Resources res,int id,String t,String c,String im) 
    {
      ...
      //-------------------------------------------------------------------------------
        ...
        Label titel = new Label(t);
        Container tit = new Container();
        
        Label Content = new Label(c);
        Label lcontent = new Label("Article :");
        Container con = new Container();
        sb.setText("Share Blog");
        ...
        tit.addAll(ltitle,titel);
        con.addAll(lcontent,Content);
        this.add(tit).add(image).add(con).add(sb);
