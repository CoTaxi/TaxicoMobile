 ...
 * @author ASUS
 */
public class AjoutBlog extends BaseForm
{
    private String path;
...
//--------------------------------------------
        ...
        Button btn = new Button("Add the Blog");
        ...
        btn.addActionListener((evt) -> {
            if ((tfTitle.getText().length() == 0) || (tfContent.getText().length() == 0)) {
                ...
                try {
                    ...
                    if (new ForumService().addForum(f,Statics.sessionID)) {
                        Dialog.show("SUCCESS", "Blog Ajoute", "OK", null);
                    } else {
        ...
        this.addAll(tfTitle,tfContent,image,btn);
