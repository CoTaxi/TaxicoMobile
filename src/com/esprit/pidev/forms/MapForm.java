...
public MapForm() {
        ...
        Button camera = new Button("enregistrer et continuer");
        ...
        cnt.addTapListener(e->{
                ...
                cnt.addMarker(
                        ...
                        "",
                        e3->{
                                ToastBar.showMessage("tu as cliqué "+cnt.getName(), FontImage.MATERIAL_PLACE);
                        }
                );
           ...
           try {
               java.util.Map<String, Object> saisons = jsonp.parseJSON(new CharArrayReader(new String(r.getResponseData()).toCharArray()));
                             
                              List<java.util.Map<String, Object>> list1 = (List<java.util.Map<String, Object>>)saisons.get("coordonnees");
        ...
        Container root = new Container();
         ...
         f.addComponent(BorderLayout.SOUTH, camera);
f.show();
