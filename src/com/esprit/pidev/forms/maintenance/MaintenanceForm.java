...
private Resources theme;
    public MaintenanceForm(Resources res) {
       ...
       super("Nos Services", BoxLayout.y());
        ...
        addButton(res.getImage("cov.png"), "Liste des rendez-vous.",res);
        addButton(res.getImage("cov.png"), "Reserver un rendez-vous.",res);
        //addButton(res.getImage("colis.png"), "Envoyer Colis.",res);
